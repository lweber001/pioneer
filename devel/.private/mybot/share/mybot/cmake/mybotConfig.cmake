...
if("TRUE" STREQUAL "TRUE")
  set(mybot_SOURCE_PREFIX /home/louis/pioneer/src/mybot)
  set(mybot_DEVEL_PREFIX /home/louis/pioneer/devel/.private/mybot)
  set(mybot_INSTALL_PREFIX "")
  set(mybot_PREFIX ${mybot_DEVEL_PREFIX})
else()
  set(mybot_SOURCE_PREFIX "")
  set(mybot_DEVEL_PREFIX "")
  set(mybot_INSTALL_PREFIX /home/louis/pioneer/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'mybot' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'lweber <lweber@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'mybot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/louis/pioneer/src/mybot/${idir}'.  Ask the maintainer 'lweber <lweber@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/louis/pioneer/devel/.private/mybot/lib;/home/louis/pioneer/devel/lib;/opt/ros/kinetic/lib)
...
set(depends "robot_state_publisher;urdf;geometry_msgs;sensor_msgs;std_msgs;tf")
